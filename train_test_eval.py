...
if __name__ == "__main__":
    ...
    parser.add_argument('--data_root', default='XXX', type=str, help='data path')
    ...
    parser.add_argument('--lr_decay_gamma', default=0.2, type=int, help='learning rate decay')
    parser.add_argument('--lr', default=1e-4, type=int, help='learning rate')
    parser.add_argument('--epochs', default=71, type=int, help='epochs')
    parser.add_argument('--batch_size', default=8, type=int, help='batch_size')
   
    parser.add_argument('--stepvalue1', default=60000, type=int, help='the step 1 for adjusting lr')
    parser.add_argument('--stepvalue2', default=90000, type=int, help='the step 2 for adjusting lr')
    parser.add_argument('--stepvalue3', default=120000, type=int, help='the step 2 for adjusting lr')
    
    parser.add_argument('--trainset', default='NJUD+NLPR+DUTLF-Depth+COME15K', type=str, help='Trainging set')
    ...
    parser.add_argument('--test_paths', type=str, default='NJUD+NLPR+DUTLF-Depth+ReDWeb-S+STERE+SSD+SIP+RGBD135+LFSD+COME-E+COME-H')
    #parser.add_argument('--test_paths', type=str, default='NJUD')

    # evaluation
    parser.add_argument('--Evaluation', default=True, type=bool, help='Evaluation or not')
    parser.add_argument('--methods', type=str, default='HCT', help='evaluated method name')
